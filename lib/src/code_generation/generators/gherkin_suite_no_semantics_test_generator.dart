...
import 'package:flutter_gherkin_automated/src/code_generation/annotations/gherkin_full_no_semantics_test_suite_annotation.dart';
...
class GherkinSuiteTestNoSemanticsGenerator
    extends GeneratorForAnnotation<GherkinNoSemanticsTestSuite> {
  static const String TEMPLATE = '''
class _CustomGherkinIntegrationTestRunner extends GherkinIntegrationTestNoSemanticsRunner {
