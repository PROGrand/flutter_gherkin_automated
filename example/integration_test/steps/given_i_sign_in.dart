...
final givenISignIn = given2<String, String, FlutterWorld>(RegExp(r'I sign in with email {string} and password {string}'), (email, password, context) async {

  final emailField = context.world.appDriver.findBy('email', FindType.key);
  final passwordField = context.world.appDriver.findBy('password', FindType.key);
  final loginButton = context.world.appDriver.findBy('loginButton', FindType.key);

  await context.world.appDriver.nativeDriver.enterText(
      emailField, email
  );
